...
const baseSnapshotProposal: object = {
  creator: "",
  id: 0,
  iteration: "",
  logSnap: "",
...
export const SnapshotProposal = {
  encode(message: SnapshotProposal, writer: Writer = Writer.create()): Writer {
    if (message.creator !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): SnapshotProposal {
    ...
    const message = { ...baseSnapshotProposal } as SnapshotProposal;
